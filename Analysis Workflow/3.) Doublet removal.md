...
####  clustering
        ...
        ##  visualize clustering
            plots <- lapply(seq_along(Scn2a.P4.list), function(i) {
                     DimPlot(Scn2a.P4.list[[i]]) + ggtitle(as.character(i))
                     }) 
      
            combiplots <- wrap_plots(plots, ncol = 4) & NoLegend()
            combiplots
...
###  extract and plot doublet identities

####  check classifiers
    names(Scn2a.P4_1@meta.data)
    names(Scn2a.P4_1@meta.data[11]) #  "pANN_0.25_0.18_81" - DOUBLET SCORES ARE STORED HERE
    names(Scn2a.P4_1@meta.data[12]) #  "DF.classifications_0.25_0.18_81" - CLASSIFICATION AS 'Doublet' OR 'Singlet' STORED HERE
    which(startsWith(names(Scn2a.P4_1@meta.data), "pANN"))     # 11
    which(startsWith(names(Scn2a.P4_1@meta.data), "DF.classification")) # 12

####  extract doublet lists
    doublets_1 = rownames(Scn2a.P4_1@meta.data)[which(Scn2a.P4_1@meta.data[[which(startsWith(names(Scn2a.P4_1@meta.data), "DF.classifications"))]] == "Doublet")]
    doublets_2 = rownames(Scn2a.P4_2@meta.data)[which(Scn2a.P4_2@meta.data[[which(startsWith(names(Scn2a.P4_2@meta.data), "DF.classifications"))]] == "Doublet")]
    doublets_3 = rownames(Scn2a.P4_3@meta.data)[which(Scn2a.P4_3@meta.data[[which(startsWith(names(Scn2a.P4_3@meta.data), "DF.classifications"))]] == "Doublet")]
    doublets_4 = rownames(Scn2a.P4_4@meta.data)[which(Scn2a.P4_4@meta.data[[which(startsWith(names(Scn2a.P4_4@meta.data), "DF.classifications"))]] == "Doublet")]
    doublets_5 = rownames(Scn2a.P4_5@meta.data)[which(Scn2a.P4_5@meta.data[[which(startsWith(names(Scn2a.P4_5@meta.data), "DF.classifications"))]] == "Doublet")]
    doublets_6 = rownames(Scn2a.P4_6@meta.data)[which(Scn2a.P4_6@meta.data[[which(startsWith(names(Scn2a.P4_6@meta.data), "DF.classifications"))]] == "Doublet")]
    doublets_7 = rownames(Scn2a.P4_7@meta.data)[which(Scn2a.P4_7@meta.data[[which(startsWith(names(Scn2a.P4_7@meta.data), "DF.classifications"))]] == "Doublet")]
    doublets_8 = rownames(Scn2a.P4_8@meta.data)[which(Scn2a.P4_8@meta.data[[which(startsWith(names(Scn2a.P4_8@meta.data), "DF.classifications"))]] == "Doublet")]
    doublets_9 = rownames(Scn2a.P4_9@meta.data)[which(Scn2a.P4_9@meta.data[[which(startsWith(names(Scn2a.P4_9@meta.data), "DF.classifications"))]] == "Doublet")]
    doublets_10 = rownames(Scn2a.P4_10@meta.data)[which(Scn2a.P4_10@meta.data[[which(startsWith(names(Scn2a.P4_10@meta.data), "DF.classifications"))]] == "Doublet")]

####  plot doublet scores
    P1 <- FeaturePlot(Scn2a.P4_1, reduction = "umap", features = names(Scn2a.P4_1@meta.data[which(startsWith(names(Scn2a.P4_1@meta.data), "pANN"))])) + labs(title = "1")
    P2 <- FeaturePlot(Scn2a.P4_2, reduction = "umap", features = names(Scn2a.P4_2@meta.data[which(startsWith(names(Scn2a.P4_2@meta.data), "pANN"))])) + labs(title = "1")
    P3 <- FeaturePlot(Scn2a.P4_3, reduction = "umap", features = names(Scn2a.P4_3@meta.data[which(startsWith(names(Scn2a.P4_3@meta.data), "pANN"))])) + labs(title = "1")
    P4 <- FeaturePlot(Scn2a.P4_4, reduction = "umap", features = names(Scn2a.P4_4@meta.data[which(startsWith(names(Scn2a.P4_4@meta.data), "pANN"))])) + labs(title = "1")
    P5 <- FeaturePlot(Scn2a.P4_5, reduction = "umap", features = names(Scn2a.P4_5@meta.data[which(startsWith(names(Scn2a.P4_5@meta.data), "pANN"))])) + labs(title = "1")
    P6 <- FeaturePlot(Scn2a.P4_6, reduction = "umap", features = names(Scn2a.P4_6@meta.data[which(startsWith(names(Scn2a.P4_6@meta.data), "pANN"))])) + labs(title = "1")
    P7 <- FeaturePlot(Scn2a.P4_7, reduction = "umap", features = names(Scn2a.P4_7@meta.data[which(startsWith(names(Scn2a.P4_7@meta.data), "pANN"))])) + labs(title = "1")
    P8 <- FeaturePlot(Scn2a.P4_8, reduction = "umap", features = names(Scn2a.P4_8@meta.data[which(startsWith(names(Scn2a.P4_8@meta.data), "pANN"))])) + labs(title = "1")
    P9 <- FeaturePlot(Scn2a.P4_9, reduction = "umap", features = names(Scn2a.P4_9@meta.data[which(startsWith(names(Scn2a.P4_9@meta.data), "pANN"))])) + labs(title = "1")
    P10 <- FeaturePlot(Scn2a.P4_10, reduction = "umap", features = names(Scn2a.P4_10@meta.data[which(startsWith(names(Scn2a.P4_10@meta.data), "pANN"))])) + labs(title = "1")
              
    P1 + P2 + P3 + P4 + P5 + P6 + P7 + P8 + P9 + P10 + plot_layout(ncol=4)

<p align="center">
<img src="https://github.com/mstockebrand/GABRA5_scRNAseq_Mm_P4_hpc/blob/main/Analysis Workflow/Figures/Doublet_Removal_Figs/Doublet_Removal_2_doublet_scores.png" width="801" height="534"/>
</p>
          
####  plot doublet classification
    P1 <- DimPlot(Scn2a.P4_1, reduction = "umap", 
                  group.by = names(Scn2a.P4_1@meta.data[which(startsWith(names(Scn2a.P4_1@meta.data), "DF.classification"))]), 
                  order = "Doublet", cols = c("blue", "red")) + 
                  labs(title = levels(as.factor(Scn2a.P4_1$sample_no)))
    P2 <- DimPlot(Scn2a.P4_1, reduction = "umap", 
                  group.by = names(Scn2a.P4_1@meta.data[which(startsWith(names(Scn2a.P4_1@meta.data), "DF.classification"))]), 
                  order = "Doublet", cols = c("blue", "red")) + 
                  labs(title = levels(as.factor(Scn2a.P4_1$sample_no)))
    P3 <- DimPlot(Scn2a.P4_1, reduction = "umap", 
                  group.by = names(Scn2a.P4_1@meta.data[which(startsWith(names(Scn2a.P4_1@meta.data), "DF.classification"))]), 
                  order = "Doublet", cols = c("blue", "red")) + 
                  labs(title = levels(as.factor(Scn2a.P4_1$sample_no)))
    P4 <- DimPlot(Scn2a.P4_1, reduction = "umap", 
                  group.by = names(Scn2a.P4_1@meta.data[which(startsWith(names(Scn2a.P4_1@meta.data), "DF.classification"))]), 
                  order = "Doublet", cols = c("blue", "red")) + 
                  labs(title = levels(as.factor(Scn2a.P4_1$sample_no)))
    P5 <- DimPlot(Scn2a.P4_1, reduction = "umap", 
                  group.by = names(Scn2a.P4_1@meta.data[which(startsWith(names(Scn2a.P4_1@meta.data), "DF.classification"))]), 
                  order = "Doublet", cols = c("blue", "red")) + 
                  labs(title = levels(as.factor(Scn2a.P4_1$sample_no)))
    P6 <- DimPlot(Scn2a.P4_1, reduction = "umap", 
                  group.by = names(Scn2a.P4_1@meta.data[which(startsWith(names(Scn2a.P4_1@meta.data), "DF.classification"))]), 
                  order = "Doublet", cols = c("blue", "red")) + 
                  labs(title = levels(as.factor(Scn2a.P4_1$sample_no)))
    P7 <- DimPlot(Scn2a.P4_1, reduction = "umap", 
                  group.by = names(Scn2a.P4_1@meta.data[which(startsWith(names(Scn2a.P4_1@meta.data), "DF.classification"))]), 
                  order = "Doublet", cols = c("blue", "red")) + 
                  labs(title = levels(as.factor(Scn2a.P4_1$sample_no)))
    P8 <- DimPlot(Scn2a.P4_1, reduction = "umap", 
                  group.by = names(Scn2a.P4_1@meta.data[which(startsWith(names(Scn2a.P4_1@meta.data), "DF.classification"))]), 
                  order = "Doublet", cols = c("blue", "red")) + 
                  labs(title = levels(as.factor(Scn2a.P4_1$sample_no)))
    P9 <- DimPlot(Scn2a.P4_1, reduction = "umap", 
                  group.by = names(Scn2a.P4_1@meta.data[which(startsWith(names(Scn2a.P4_1@meta.data), "DF.classification"))]), 
                  order = "Doublet", cols = c("blue", "red")) + 
                  labs(title = levels(as.factor(Scn2a.P4_1$sample_no)))
    P10 <- DimPlot(Scn2a.P4_1, reduction = "umap", 
                  group.by = names(Scn2a.P4_1@meta.data[which(startsWith(names(Scn2a.P4_1@meta.data), "DF.classification"))]), 
                  order = "Doublet", cols = c("blue", "red")) + 
                  labs(title = levels(as.factor(Scn2a.P4_1$sample_no)))         
...
<p align="center">
<img src="https://github.com/mstockebrand/GABRA5_scRNAseq_Mm_P4_hpc/blob/main/Analysis Workflow/Figures/Doublet_Removal_Figs/Doublet_Removal_3_doublet_classification.png" width="801" height="534"/>
