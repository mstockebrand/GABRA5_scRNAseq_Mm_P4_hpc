...
Files 'P4_agg_barcodes.tsv.gz', 'P4_agg_features.tsv.gz', 'P4_agg_matrix.mtx.gz' were downloaded, renamed to 'barcodes.tsv.gz', 'features.tsv.gz', 'matrix.mtx.gz', respectively and transfered to a folder named "C:\scRNA-seq_Mouse_P4\filtered_bc_matrix\\" on a windows machine.
