...
**scRNA-seq analysis of mpoue age postnadal day (P)4 hippocampal dataset** (Liebeskind et al. submitted to Commun Biol, November 2025)
...
The dataset will be available from EMBL-EBI's BioStudies database (http://www.ebi.ac.uk/biostudies) upon publication under accession number E-MTAB-15970 (https://www.ebi.ac.uk/biostudies/arrayexpress/studies/E-MTAB-15970).
